...
@section('content')
    <div class="mt-5">
        ...
        <div class="container py-5" data-aos="fade-up">
            <p class="fs-1 fw-bold mb-3">Kumpulan informasi di Masjid Al-Amin</p>
            <div class="accordion accordion-flush" id="accordionInfo">
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            <p>
                                Kami menyediakan layanan ZISWAF (Zakat, Infaq, Sedekah, dan Wakaf) untuk membantu masyarakat
                                dalam rangka mensejahterakan umat.
                            </p>
                            <p>
                                Kami juga menyediakan layanan konsultasi keagamaan bagi jamaah yang membutuhkan bimbingan
                                spiritual.
                            </p>
                        </div>
                    </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            <p>Kami mengadakan berbagai kegiatan keagamaan, seperti kajian majelis ilmu, BASABASU (Belanja
